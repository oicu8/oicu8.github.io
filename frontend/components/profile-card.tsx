...
import { UserInfo, LifeChain } from "../lib/lifechain";
...
export default class ProfileCard extends React.Component<Props, State> {
  ...
  initState(userInfo: UserInfo) {
    ...
    const followingUsernames = this.props.lifechain.settings.followingUsernames;
      ...
      <I18n>
        {(t, { i18n }) => (
          <div className="profile-card card">
            ...
            this.props.lifechain.userInfo.username ===
