  ...
  resources: {
    en: {
      translation: {
        ...
        "general/Post-to-lifechain": "Post to #{lifechain} topic",
        ...
        "routes/signup/title": "Welcome to use LifeChain!",
        ...
        "notification/init-error":
          "Failed to initialize LifeChain. Please make sure you have MetaMask enabled and unlocked.",
